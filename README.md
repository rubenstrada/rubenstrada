<h1 align="left">Hey, I'm Rubén 👨‍💻</h1>

<p align="left">
  <em>Data Analyst based in Monterrey, México · turning messy operational data into decisions that leadership trusts.</em>
</p>
...
class RubenEstrada:
    ...
    def current_focus(self):
        return "Building analytics infrastructure end-to-end — \
                from raw ERP extracts to executive dashboards."
```
